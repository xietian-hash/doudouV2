...
Page({
  data: {
    ...
    summary: {
      ...
      dailyAvg: '',
      dailyAvgChangeText: '',
      dailyAvgChangeDir: 'down',
      monthlyAvg: '',
      monthlyAvgChangeText: '',
      monthlyAvgChangeDir: 'down',
      yearOverYearText: '',
  ...
  applyOverview(overview, trend) {
    ...
    const summaryView = {
      ...
      dailyAvgChangeText: formatChange(summary.dailyAvgChangePercent) || '',
      dailyAvgChangeDir: changeDir(summary.dailyAvgChangePercent, type),
      monthlyAvg: summary.monthlyAvg || '',
      monthlyAvgChangeText: formatChange(summary.monthlyAvgChangePercent) || '',
      monthlyAvgChangeDir: changeDir(summary.monthlyAvgChangePercent, type),
